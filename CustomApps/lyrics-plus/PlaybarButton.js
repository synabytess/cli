(function PlaybarButton() {
	...
	const button = new skidify.Playbar.Button(
		"Lyrics Plus",
		...
		() =>
			skidify.Platform.History.location.pathname !== "/lyrics-plus"
				? skidify.Platform.History.push("/lyrics-plus")
				: skidify.Platform.History.goBack(),
		false,
		skidify.Platform.History.location.pathname === "/lyrics-plus",
		false
	);
	...
	if (skidify.LocalStorage.get("lyrics-plus:visual:playbar-button") === "true") setPlaybarButton();
	...
	skidify.Platform.History.listen((location) => {
